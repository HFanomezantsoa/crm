...
public class DataServiceImpl implements DataService {
    ...
    public void multipleImport(MultipartFile customerFile, MultipartFile ticketFile, MultipartFile budgetFile,
        ...
        HashMap<String, Customer> customerMap = importCustomer(customerFile);
    ...
    @Override
    public HashMap<String, Customer> importCustomer(MultipartFile customerFile) throws IOException, CsvValidationException, DataException {
        List<String> errors = new ArrayList<>();
